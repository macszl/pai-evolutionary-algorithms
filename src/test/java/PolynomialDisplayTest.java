...
public class PolynomialDisplayTest
{
	...
	public static void main (String[] args)
	{
		...
		boolean geneticAlgorithmUsed = true;
		String scannedMessage = "f(x) = x^2 + 4x + 4";
		...
		for (int i = 0; i < 3; i++)
		{
			...
			annealingAlgorithmParams.startTemp = 8000;
			annealingAlgorithmParams.coolingRate = 0.1;
			annealingAlgorithmParams.endTemp = 0.1;
			annealingAlgorithmParams.iterationsCnt = 3000;
